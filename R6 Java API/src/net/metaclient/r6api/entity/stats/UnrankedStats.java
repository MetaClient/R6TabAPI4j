...
public class UnrankedStats {
	
	int kills, deaths, matchWins, matchLooses, timePlayed, hoursPlayed, matches;
	String kd, winLooseRate;
	
	public UnrankedStats(int kills, int deaths, int matchWins, int matchLooses, int timePlayed, int hoursPlayed, int matches, String kd, String winLooseRate) {
		this.kills = kills;
		this.deaths = deaths;
